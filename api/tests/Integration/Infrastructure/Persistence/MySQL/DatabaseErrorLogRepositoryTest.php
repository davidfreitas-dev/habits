...
class DatabaseErrorLogRepositoryTest extends DatabaseTestCase
{
    ...
    public function testSaveAndFindById(): void
    {
        ...
        $this->assertNotNull($createdErrorLog->getId(), 'O ID do ErrorLog não deve ser nulo após salvar');

        $foundErrorLog = $this->errorLogRepository->findById($createdErrorLog->getId());

        $this->assertNotNull($foundErrorLog, 'Deve encontrar um log de erro por ID');
    ...
    public function testMarkAsResolved(): void
    {
        ...
        $this->assertTrue($resolved, 'markAsResolved deve retornar verdadeiro em caso de sucesso');

        $resolvedErrorLog = $this->errorLogRepository->findById($errorLog->getId());

        $this->assertNotNull($resolvedErrorLog->getResolvedAt(), 'ResolvedAt deve ser definido');
