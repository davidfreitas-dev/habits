...
class GetHabitsSummaryTest extends FunctionalTestCase
{
    ...
    public function testGetSummaryReturnsOk(): void
    {
        // Arrange
        $habitId1 = $this->createHabit($this->faker->sentence(3), [1, 2, 3]);
        $habitId2 = $this->createHabit($this->faker->sentence(3), [1, 4, 5]);
        ...
        // Act
        $response = $this->sendRequest('GET', '/api/v1/habits/summary', [], [
            'Authorization' => 'Bearer ' . $this->accessToken,
        ]);
