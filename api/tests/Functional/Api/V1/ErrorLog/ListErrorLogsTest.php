...
class ListErrorLogsTest extends FunctionalTestCase
{
    ...
    public function testListErrorLogsAsAdmin(): void
    {
        ...
        $this->assertArrayHasKey('error_logs', $body['data']);
        $this->assertCount(2, $body['data']['error_logs']);
        $this->assertEquals('Error 2', $body['data']['error_logs'][0]['message']);
        $this->assertEquals('CRITICAL', $body['data']['error_logs'][1]['severity']);
    }
