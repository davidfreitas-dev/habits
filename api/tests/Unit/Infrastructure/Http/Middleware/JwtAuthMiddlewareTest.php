...
class JwtAuthMiddlewareTest extends TestCase
{
    ...
    public function testProcessWithInvalidToken(): void
    {
        ...
        $this->jwtService->method('validateToken')->with('invalid_token')->willThrowException(new AuthenticationException('Token inválido'));
        $this->jsonResponseFactory->expects($this->once())->method('fail')->with(null, 'Token inválido', 401);
